...
g++ -O2 -static -mwindows -municode -Isrc src/globals.cpp src/log.cpp src/config.cpp src/process.cpp src/overlay.cpp src/cdp.cpp src/main.cpp -o matlab_bg.exe -ldwmapi -luser32 -lgdi32 -lgdiplus -lole32 -lcomctl32 -lws2_32 2>&1
